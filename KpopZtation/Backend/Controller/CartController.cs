...
namespace KpopZtation.Backend.Controller
{
    public class CartController
    {
        ...
        public static Data<List<Cart>> Checkout(int CustomerId)
        {
            List<Cart> Object = CartHandler.Checkout(CustomerId); 
            return new Data<List<Cart>>("Succesfully checkout ", Object, true);
        }
