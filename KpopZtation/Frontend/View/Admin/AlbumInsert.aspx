<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AlbumInsert.aspx.cs" MasterPageFile="~/Frontend/View/Template/Template.Master" Inherits="KpopZtation.Frontend.View.Admin.AlbumInsert" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10 flex flex-col gap-2">
        ...
        <%-- Album Name Input --%>
        <div>
            <asp:Label CssClass="block text-sm font-medium text-gray-700" ID="AlbumLabel" runat="server" Text="Album Name"></asp:Label>
            <div class="mt-1">
                <asp:TextBox
        ...
        <div class="mt-2">
            <asp:Label CssClass="block text-sm font-medium text-gray-700" ID="PasswordLabel" runat="server" Text="Album Description"></asp:Label>
            <div class="mt-1">
                <asp:TextBox
                    CssClass="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                    ID="AlbumDescriptionInput"
                    runat="server"
                    TextMode="MultiLine"
                    Rows="4"></asp:TextBox>
            </div>
        ...
        <%-- Album Price Input --%>
        <div class="mt-2">
            <asp:Label CssClass="block text-sm font-medium text-gray-700" ID="NameLabel" runat="server" Text="Price"></asp:Label>
            <div class="mt-1">
                <asp:TextBox ID="AlbumPriceInput" 
        ...
        <%-- Album Stock Input --%>
        <div class="mt-2">
            <asp:Label CssClass="block text-sm font-medium text-gray-700" ID="Label1" runat="server" Text="Stock"></asp:Label>
            <div class="mt-1">
                <asp:TextBox ID="AlbumStockInput" 
                    CssClass="wappearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" 
                    runat="server"></asp:TextBox>
            </div>
        </div>
        ...
        <div class="mt-2">
            ...
            <div class="mt-1">
                <asp:FileUpload runat="server" ID="AlbumImageInput"></asp:FileUpload>
            </div>
        </div>
